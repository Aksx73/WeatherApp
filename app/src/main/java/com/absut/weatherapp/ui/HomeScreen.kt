...
@Composable
fun HomeScreen(modifier: Modifier = Modifier,viewModel: WeatherViewModel,onRefreshClicked : () -> Unit) {
        ...
        when (uiState) {
            ...
            is WeatherUIState.Success -> {
                (uiState as WeatherUIState.Success).weatherInfo?.let {
                    HomeContent(weatherInfo = it, location = locationName, onRefreshClicked = { onRefreshClicked() })
                }
            }
        }
    }
...
@Composable
fun HomeContent(modifier: Modifier = Modifier, weatherInfo: WeatherInfo, location: String?,onRefreshClicked : () -> Unit) {
